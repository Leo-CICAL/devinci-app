!(function () {
...
})()(
    {
        1: [
            ...
            { "@marcom/ac-function/memoize": 4, "@marcom/ac-prefixer/getStyleProperty": 6, "@marcom/ac-prefixer/getStyleValue": 7 },
        ],
        2: [
            function (t, e, i) {
                "use strict";
                ...
                (o._initializeDirectory = function () {
                    if (((this._directory = this.el.querySelector(this._selectors.directory)), this._directory))
                        for (var t, e, i, r = this._directory.querySelectorAll(this._selectors.directory + "-column-section-state"), n = 0; n < r.length; n++)
                            (t = r[n].nextElementSibling),
                                //(e = t.querySelector(this._selectors.directory + "-column-section-anchor-open")),
                                //(i = t.querySelector(this._selectors.directory + "-column-section-anchor-close")),
                                s.create(r[n], e, i);
                }),
                    (o._initializeLangLink = function () {
                        ...
                        (this._langLink = this.el.querySelector(this._selectors.mini + "-locale-lang")),
                            this._langLink &&
                                ...
                                t.indexOf(e) !== -1 && ((t = t.replace(e, i)), "/" !== t.charAt(0) && (t = "/" + t), (this._langLink.href = t)));
                    }),
                    (e.exports = r);
            },
        ...
        6: [
            function (t, e, i) {
                ...
                var r = t("./shared/stylePropertyCache"),
                    ...
                    a = function (t, e) {
                        var i = n(t),
                            s = e !== !1 && n(e);
                        return (r[t] = r[e] = r[i] = r[s] = { dom: e, css: s }), e;
                    };
            ...
            { "./shared/getStyleTestElement": 8, "./shared/prefixHelper": 9, "./shared/stylePropertyCache": 10, "./utils/toCSS": 12, "./utils/toDOM": 13 },
        ],
        7: [
            function (t, e, i) {
                "use strict";
            ...
            { "./getStyleProperty": 6, "./shared/prefixHelper": 9, "./shared/stylePropertyCache": 10, "./shared/styleValueAvailable": 11 },
        ],
        8: [
            function (t, e, i) {
                "use strict";
        ...
        11: [
            ...
            { "./getStyleTestElement": 8, "./stylePropertyCache": 10 },
        ],
        12: [
            function (t, e, i) {
                "use strict";
        ...
        15: [
            function (t, e, i) {
                ...
                var r = t("@marcom/ac-footer/Footer"),
                    ...
                    o = function (t) {
                        var e = new s(t);
                        e.addTests({ flexbox: n("justify-content") }), e.htmlClass(), r.call(this, t, { className: "ac-gf", miniSelector: ".ac-gf-footer" }), this._initializeBuyStrip(), this._initializeChatLink();
                    },
                    c = r.prototype,
                ...
                (o.prototype.constructor = o),
                    ...
                    (a._initializeChatLink = function () {
                        ...
                        this._buystrip &&
                            ...
                            this._chatLink && ((t = this._chatLink.parentNode), t.href && (this._chatLink = t), (this._onChatLinkClick = this._onChatLinkClick.bind(this)), this._chatLink.addEventListener("click", this._onChatLinkClick)));
                    }),
                    ...
                    (a._makeBlockLink = function (t) {
                        ...
                        if ((e = t.querySelector("a"))) {
                            (r = document.createElement("a")),
                                (r.className = "ac-gf-block"),
                                (r.href = e.href),
                                "analyticsTitle" in e.dataset && (r.dataset.analyticsTitle = e.dataset.analyticsTitle),
                                "analyticsExitLink" in e.dataset && (r.dataset.analyticsExitLink = e.dataset.analyticsExitLink),
                                (i = document.createElement("span")),
                                (i.className = e.className + " ac-gf-block-link"),
                                (i.innerHTML = e.innerHTML),
                                (e.parentNode.className += " with-cta"),
                                e.parentNode.replaceChild(i, e),
                                t.insertBefore(r, t.firstChild);
                            for (; t.childNodes.length > 1 && ((s = t.childNodes[1]), !s.href); ) r.appendChild(s);
                        }
                    }),
                    (e.exports = o);
            },
            { "@marcom/ac-feature/cssPropertyAvailable": 1, "@marcom/ac-footer/Footer": 2, "@marcom/ac-headjs/FeatureDetect": 5 },
        ],
    },
    {},
    [14]
